...
import com.example.GreenStitch_Backend_Assignment.Services.MyUserDetailsServices;
...
public class JWTGenerationFilter extends OncePerRequestFilter {
    ...
    @Autowired
    private JwtValidationFilter jwtValidationFilterl;
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (requestTokenHeader != null && requestTokenHeader.startsWith("Bearer ")) {
            ...
            try {
                username = jwtValidationFilterl.getUsernameFromToken(jwtToken);
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (jwtValidationFilterl.validateToken(jwtToken, userDetails)) {
